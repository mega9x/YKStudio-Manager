...
<script language="JavaScript">
    ...
    function CheckInput() {
        if (document.getElementById('excelfile').value == "") {
            art.dialog({title: 'Error', time: 1, icon: 'warning', content: '未选择要导入的文件！'});
            document.getElementById('excelfile').focus();
            return false;
        }
        if (document.getElementById('User').value == "") {
            art.dialog({title: 'Error', time: 1, icon: 'warning', content: '未选择业务员！'});
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td valign="top" class="td_n pd10">
            <form name="importForm" action="<?php echo site_url('import/daoru/') ?>" enctype="multipart/form-data"
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" CLASS="table_1">
                    ...
                    <tr>
                        ...
                        <td class="td_r_l"><input name="file" type="file" id="file" value="" maxlength="200" class="int"
                                                  size="40">
                        </td>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
                    <tr>
                        <td colspan="2">
                            <input type="submit" name="Submit" class="btn2 btnbaoc" value=" 开始导入 "><a
                                    href='<?php echo base_url('data/AnotherOne.xls') ?>' target='_blank'
                                    class='btn2 btnsous' style='color:#fff;'>模板下载</a>　
                        </td>
                    </tr>
                </table>
            </form>
