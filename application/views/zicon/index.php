...
<ul class="xhing">
 ...
 <td class="td_l_c" style="padding:5px;"><img src="<?php echo base_url()?>theme/windows/icon1/<?php echo $row['icon']?>" width="60" height="60"
 /></td>
 ...
 <td class="td_l_c">
 <input type="button" class="btn1 btnxiug" value="修改" title="修改"  onclick='Zicon_InfoEdit<?php echo $row['id']?>()' />
 <input type="button" class="btn1 btnshanc" value="删除" title="删除" onclick="if(confirm(' 你真的要删除吗？'))

{location.href='<?php echo site_url('zicon/del')?>?id=<?php echo $row['id']?>';};" /></td>
 </tr>
 <script>function Zicon_InfoEdit<?php echo $row['id']?>() {$.dialog.open('<?php echo site_url('zicon/edit')?>?id=<?php echo $row['id']?>', {title: '修改图标', width: 500,height: 350, fixed: true}); };</script>
 <?php }?>
 </table></td>
 </tr>
 </table></td>
 ...
 <script>function Zicon_Add() {$.dialog.open('<?php echo site_url('zicon/add')?>', {title: '新增图标', width: 500, height: 350,fixed: true}); };</script>
