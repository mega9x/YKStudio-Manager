...
<img id="loading" src="<?php echo base_url() ?>theme/windows/images/loading2.gif"
     style="position:absolute; top:49%; left:50%; margin-left:-73px;">
<head>
    <title>CRM任务管理系统</title>
    <link rel="shortcut icon" href="<?php echo base_url() ?>theme/default/images/Favicon.ico" type="image/x-icon"/>
    <link href="<?php echo base_url() ?>theme/windows/css/jquery-ui-1.8.24.custom.css" rel="stylesheet"
          type="text/css"/>
    ...
    <script type="text/javascript"
            src="<?php echo base_url() ?>theme/windows/js/jquery-ui-1.8.24.custom.min.js"></script>
    ...
    <script type="text/javascript"
            src="<?php echo base_url() ?>theme/windows/js/win-desk-new.js?<?php echo time() ?>"></script>
    <!--[if lt IE 7]>
    <style type="text/css">
        div, img {
    ...
    <link href="<?php echo base_url() ?>theme/layui/css/layui.css?<?php echo time() ?>" rel="stylesheet"
          type="text/css"/>
                ...
                <div class="page1">
                    <div class="content">
                        <div class="first_screen">
                            <div class="time"><span id="h1"></span> <span id="h2"></span><strong>:</strong> <span
                                        id="m1"></span> <span id="m2"></span><strong>:</strong> <span id="s1"></span>
                                <span id="s2"></span></div>
...
<div id="themezoom" class="themezoom"
     style="background:url(<?php echo get_cookie('themepic') ? base_url(get_cookie('themepic')) : base_url('theme/windows/bg/bg1.jpg') ?>) 100% 0 repeat;">
    <!--<img id="themebg" class="themebg" src="<?php echo base_url() ?>theme/windows/bg/bg3.jpg">--></div>
    ...
    <div id="theme_body" class="theme_body">
        <div id="theme_area" class="theme_area" style="display: block;">
            <?php foreach ($theme as $arr => $row) { ?>
                <a href="javascript:;" themeid="theme_<?php echo $row['id'] ?>" nowid="<?php echo $row['id'] ?>"
                   bigpicurl="<?php echo base_url($row['bigpic']) ?>" class="theme_setting "
                   id="theme_id_<?php echo $row['id'] ?>">
                    <div class="theme_icon"><img src="<?php echo base_url($row['smallpic']) ?>" width="140"
                                                 height="100"></div>
...
<script>function Theme_Add() {
        $.dialog.open('<?php echo site_url('theme/add')?>', {
            title: '自定义主题',
            width: 800,
            height: 500,
            fixed: true
...
<div id="RightDesk1" class="RDclass">
    <div class="RDtitle"><span><a href="javascript:;" title="删除卡片" onClick="CloseRD1();"><img
                        src="<?php echo base_url() ?>theme/windows/images/del.png" height="18"></a></span>跟单提醒
    </div>
    <iframe width=100% height=100% frameborder=0 scrolling=auto
            src=<?php echo site_url('notice/single') ?> allowTransparency="true"></iframe>
</div>
<div id="RightDesk2" class="RDclass">
    <div class="RDtitle"><span><a href="javascript:;" title="删除卡片" onClick="CloseRD2();"><img
                        src="<?php echo base_url() ?>theme/windows/images/del.png" height="18"></a></span>合同到期提醒
    </div>
    <iframe width=100% height=100% frameborder=0 scrolling=auto
            src=<?php echo site_url('notice/contract') ?> allowTransparency="true"></iframe>
</div>
<!--end-->
<!--短信-->
...
<a id="StartmenuA">
    <table width="99%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="50" align="center"><img src="<?php echo base_url() ?>theme/windows/images/start.png" height="35">
            </td>
...
<div id="light" class="white_content">
    <div class="spuser"><img src="<?php echo base_url() ?>theme/windows/images/avatar.jpg" class="avatar"> <br>
        <span>已锁定</span>
        <div class="sp-pass">
            <input class="input-sp" type="password" id="sppass" name="sppass" value=""
                   onKeyPress="if(event.keyCode==13) {submit.click();return false;}" placeholder="请输入登录密码"
                   autocomplete="off"/>
        </div>
...
<style>
    ...
    .RDclass {
        ...
        background: url(<?php echo base_url()?>theme/windows/images/bobg.png) repeat;
    }
    ...
    .RDtitle {
        ...
        color: #fff;
        padding: 0 3px 0 3px;
        background: url(<?php echo base_url()?>theme/windows/images/bobg-t.png);
        font-size: 12px;
    }
