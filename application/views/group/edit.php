...
<script language="JavaScript">
    ...
    function CheckInput() {
        if (document.getElementById('gId').value == "") {
            art.dialog({title: 'Error', time: 1, icon: 'warning', content: '部门编号不能为空！'});
            document.getElementById('gId').focus();
            return false;
        }
        if (document.getElementById('gName').value == "") {
            art.dialog({title: 'Error', time: 1, icon: 'warning', content: '部门名称不能为空！'});
...
<form name="Save" action="<?php echo site_url('group/edit') ?>?id=<?php echo $id ?>" method="post"
            ...
            <td valign="top" class="td_n pdl10 pdr10 pdt10">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" CLASS="table_1">
                    ...
                    <tr style="display:none;">
                        ...
                        <td class="td_l_l"><input type="text" class="int" id="gId"
                                                  onkeyup='this.value=this.value.replace(/\D/gi,"")' value="7" size="10"
                                                  maxlength="2">
                            <span class="info_help help01">限：数字 1 - 99</span></td>
                    </tr>
                    <tr>
                        <td class="td_l_r title">部门名称</td>
                        <td class="td_l_l"><input name="name" type="text" class="int" id="gName" size="30"
                                                  value="<?php echo $name ?>" maxlength="16"></td>
                    </tr>
                </table>
            </td>
        </tr>
