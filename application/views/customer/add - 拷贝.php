...
<script language="JavaScript">
    ...
    function CheckInput() {
        ...
        if (<?php echo isset($value['bt_area']) ? 1 : 0?>=="1"
    )
        {
            if ($("#area1").val() == "") {
        ...
        if (<?php echo isset($value['bt_address']) ? 1 : 0?>=="1"
    )
        {
            if ($("#address").val() == "") {
                art.dialog({title: 'Error', time: 1, icon: 'warning', content: '所在地区不能为空！'});
        ...
        if (<?php echo isset($value['bt_trade']) ? 1 : 0?>=="1"
    )
        {
            if ($("#trade").val() == "") {
        ...
        if (<?php echo isset($value['bt_website']) ? 1 : 0?>=="1"
    )
        {
            if ($("#website").val() == "") {
        ...
        if (<?php echo isset($value['bt_tel']) ? 1 : 0?>=="1"
    )
        {
            if ($("#tel").val() == "") {
                art.dialog({title: 'Error', time: 1, icon: 'warning', content: '电话不能为空！'});
                $("#tel").focus();
                return false;
            }
        }

        if (<?php echo isset($value['bt_start']) ? 1 : 0?>=="1"
    )
        {
            if ($("#start").val() == "") {
        ...
        if (<?php echo isset($value['bt_source']) ? 1 : 0?>=="1"
    )
        {
            if ($("#source").val() == "") {
        ...
        if (<?php echo isset($value['bt_record']) ? 1 : 0?>=="1"
    )
        {
            if ($("#record").val() == "") {
        ...
        if (<?php echo isset($value['bt_remark']) ? 1 : 0?>=="1"
    )
        {
            if ($("#remark").val() == "") {
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_1">
                    ...
                    <tr>
                        ...
                        <td colspan="3" class="td_r_l">
                            <input type="text" class="int" name="name" id="name" size="50" maxlength="50"
                                   autocomplete="off" onchange="check_customer_name(this.value);">
                    ...
                    <tr>
                        ...
                        <td class="td_r_l" <?php echo isset($value['hidden_area']) ? 'style="display:none;"' : '' ?>>
                            ...
                            <input name="area1" type="text" class="int" id="area_name1" value="123" size="15" readonly
                                   onclick='choose_area1()'>
                            ...
                            <input name="area2" type="text" class="int" id="area_name2" value="" size="15" readonly
                                   onclick='choose_area2()'>
                    ...
                    <tr>
                        ...
                        <td class="td_r_l">
                            <input name="linkman" type="text" class="int" id="linkman" size="10"
                                   onchange="checklinkman (this.value,1);">
                            &nbsp;
                        ...
                        <td class="td_r_l" colspan="3">
                            <input name="mobile" type="text" class="int" id="mobile" size="30"
                                   onchange="checkmobile(this.value,1);">
