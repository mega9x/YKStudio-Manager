...
<script language="JavaScript">
 ...
 function CheckInput(){
     ...
     if (<?php echo isset($value['bt_name']) ? 1 : 0?>=="1"){if ($("#name").val()== ""){ art.dialog({title: 'Error',time: 1,icon: 'warning',content: '任务名称不能为空！'});$("#name").focus();return false;}}
	 
	 
	 if (<?php echo isset($value['bt_type']) ? 1 : 0?>=="1"){if ($("#type").val()== ""){ art.dialog({title: 'Error',time: 1,icon: 'warning',content: '转化情况不能为空！'});$("#type").focus();return false;}}
	 
	 if (<?php echo isset($value['bt_area']) ? 1 : 0?>=="1"){if ($("#area1").val()== ""){ art.dialog({title: 'Error',time: 1,icon: 'warning',content: '所在地区不能为空！'});$("#area1").focus();return false;}}
	 
	 if (<?php echo isset($value['bt_area']) ? 1 : 0?>=="1"){if ($("#area2").val()== ""){ art.dialog({title: 'Error',time: 1,icon: 'warning',content: '所在地区不能为空！'});$("#area2").focus();return false;}}
	 
	 if (<?php echo isset($value['bt_address']) ? 1 : 0?>=="1"){if ($("#address").val()== ""){ art.dialog({title: 'Error',time: 1,icon: 'warning',content: '所在地区不能为空！'});$("#address").focus();return false;}}
	 
	 if (<?php echo isset($value['bt_linkman']) ? 1 : 0?>=="1"){if ($("#linkman").val()== ""){ art.dialog({title: 'Error',time: 1,icon: 'warning',content: '任务链接不能为空！'});$("#address").focus();return false;}}
	 
	 if (<?php echo isset($value['bt_job']) ? 1 : 0?>=="1"){if ($("#job").val()== ""){ art.dialog({title: 'Error',time: 1,icon: 'warning',content: '任务链接不能为空！'});$("#address").focus();return false;}}
	 
	 if (<?php echo isset($value['bt_mobile']) ? 1 : 0?>=="1"){if ($("#mobile").val()== ""){ art.dialog({title: 'Error',time: 1,icon: 'warning',content: '合作站点不能为空！'});$("#mobile").focus();return false;}}
	 
	 if (<?php echo isset($value['bt_qq']) ? 1 : 0?>=="1"){if ($("#qq").val()== ""){ art.dialog({title: 'Error',time: 1,icon: 'warning',content: '合作站点不能为空！'});$("#qq").focus();return false;}}
	 
	 if (<?php echo isset($value['bt_trade']) ? 1 : 0?>=="1"){if ($("#trade").val()== ""){ art.dialog({title: 'Error',time: 1,icon: 'warning',content: '任务类型不能为空！'});$("#trade").focus();return false;}}
	 
	 if (<?php echo isset($value['bt_website']) ? 1 : 0?>=="1"){if ($("#website").val()== ""){ art.dialog({title: 'Error',time: 1,icon: 'warning',content: '公司网址不能为空！'});$("#website").focus();return false;}}
	 
	 if (<?php echo isset($value['bt_email']) ? 1 : 0?>=="1"){if ($("#email").val()== ""){ art.dialog({title: 'Error',time: 1,icon: 'warning',content: '电子邮件不能为空！'});$("#email").focus();return false;}}
	 if (<?php echo isset($value['bt_weixin']) ? 1 : 0?>=="1"){if ($("#weixin").val()== ""){ art.dialog({title: 'Error',time: 1,icon: 'warning',content: '微信不能为空！'});$("#weixin").focus();return false;}}
	 if (<?php echo isset($value['bt_tel']) ? 1 : 0?>=="1"){if ($("#tel").val()== ""){ art.dialog({title: 'Error',time: 1,icon: 'warning',content: '电话不能为空！'});$("#tel").focus();return false;}}
	 
	 if (<?php echo isset($value['bt_start']) ? 1 : 0?>=="1"){if ($("#start").val()== ""){ art.dialog({title: 'Error',time: 1,icon: 'warning',content: '流量状况不能为空！'});$("#start").focus();return false;}}
	 
	 if (<?php echo isset($value['bt_source']) ? 1 : 0?>=="1"){if ($("#source").val()== ""){ art.dialog({title: 'Error',time: 1,icon: 'warning',content: '所属联盟不能为空！'});$("#source").focus();return false;}}

     if (<?php echo isset($value['bt_record']) ? 1 : 0?>=="1"){if ($("#record").val()== ""){ art.dialog({title: 'Error',time: 1,icon: 'warning',content: '任务代码不能为空！'});$("#record").focus();return false;}}


	  if (<?php echo isset($value['bt_remark']) ? 1 : 0?>=="1"){if ($("#remark").val()== ""){ art.dialog({title: 'Error',time: 1,icon: 'warning',content: '备注不能为空！'});$("#remark").focus();return false;}}
...
<form name="Add" action="<?php echo site_url('customer/add')?>" method="post" onSubmit="return CheckInput();">
 ...
 合作站点
				...
				<td class="td_r_l" colspan="3">
					...
					<span id="check3"><span class="info_warn help01">任务识别信息</span></span>
					<span class="info_help vtip" title="限：数字">&nbsp;</span>
				</td>
			</tr>
			<tr>
