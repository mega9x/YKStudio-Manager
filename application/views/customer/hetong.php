...
<span class="MenuboxS">
 ...
 <li class="hover"><span><a href="<?php echo site_url('customer/hetong')?>?id=<?php echo $id?>">合同记录</a></span></li>
 <?php }?>
...
<!-- <input type="button" class="button_info_add" value=" " title="快速续费"  onclick='hetong_xufei_InfoAdd<?php echo $row['id']?>()' />-->
 ...
 <script>function View12() {$.dialog.open('save1.asp?action=Client&sType=InfoView&otype=Hetong&cId=12', {title: '查看', width: 1220,height: 520, fixed: true}); };</script>
 <script>function hetong_xufei_List<?php echo $row['id']?>() {$.dialog.open('save2.asp?action=Hetong&sType=RenewList&Id=7', {title: '查看', width: 860,height: 440, fixed: true}); };</script>
...
<script>function Add() {$.dialog.open('<?php echo site_url('contract/add')?>?id=<?php echo $id?>', {title: '新增合同', width: 800, height: 550,fixed: true}); };</script>
