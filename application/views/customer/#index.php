...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
 ...
 <td width="40" nowrap="nowrap" class="td_l_c">任务国家</td>
 <?php }?>
...
<td width="80" nowrap="nowrap" class="td_l_c">转化情况</td>
 <?php }?>
 ...
 <?php }?>
 <?php if (isset($config['qq'])){?>
 <td class="td_l_c"><?php echo $row['qq']?><a class="icon-qq" title="QQ对话" href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $row['qq']?>&site=qq&menu=yes" target="_blank"></a></td>
 <?php }?>
 <?php if (isset($config['trade'])){?>
