...
<script language="JavaScript">
    ...
    function CheckInput() {
        ...
        if (<?php echo isset($config['bt_record']) ? 1 : 0?>=="1"
    )
        {
            if ($("#record").val() == "") {
                art.dialog({title: 'Error', time: 1, icon: 'warning', content: '任务代码不能为空！'});
                $("#record").focus();
                return false;
            }
        }
                ...
                ="0" CLASS="table_1">
                    ...
                    <tr>
                        ...
                        <td class="td_r_l" colspan="3"><input type="text" class="int" name="name" id="name" size="50"
                                    ...
                                    id="customer_name_err"><span class="info_warn help01">任务识别信息</span></span>
                        </td>
                    ...
                    <tr <?php echo isset($config['hidden_record']) ? 'style="display:none;"' : '' ?>>
                        ...
                        <td class="td_r_l" colspan=3 style="padding:5px 10px;">
                            <textarea name="record" id="record" class="int"
                                      style="height:50px;width:98%;"><?php echo $record ?></textarea></td>
                    </tr>
