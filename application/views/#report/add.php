...
<script language="JavaScript">
 ...
 function CheckInput()
 {
 if(document.getElementById('oReport').value == ""){art.dialog({title: 'Error',time: 1,icon: 'warning'
,content: '工作总结不能为空！'});document.getElementById('oReport').focus();return false;}
 if(document.getElementById('oFujian').value == ""){art.dialog({title: 'Error',time: 1,icon: 'warning'
,content: '附件不能为空！'});document.getElementById('oFujian').focus();return false;}
 }
 -->
 </script>
<table width="100%" border="0" cellpadding="0" cellspacing="0">
 <form name="Save" action="<?php echo site_url('report/add')?>" enctype="multipart/form-data" method="post" onSubmit="javascript:document.getElementById('oReport').value = editor.html();">
...
<!-- <tr>
 ...
 <input name="class" type="radio" class="noborder" value="日报" data-labelauty="日报" checked> 
