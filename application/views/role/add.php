                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" CLASS="table_1">
                    ...
                    <tr>
                        ...
                        <td class="td_l_l"><input name="right" type="text" class="int" id="lId" size="10" maxlength="3"
                                                  onkeyup='this.value=this.value.replace(/\D/gi,"")' value="1">
        ...
        <tr>
            <td valign="top" class="td_n pdl10 pdr10 pdt10">
                        ...
                        <tr>
                            <?php foreach ($system as $arr => $row) { ?>
                                <td class="td_l_c"><label><?php echo $row['name'] ?>
                                        <input type="checkbox" name="lever[]" value="<?php echo $row['id'] ?>"
                                               class="qxon"/></label></td>
                ...
                <fieldset style="margin-top:10px;padding:10px;">
                    <input type="button" class="button246" onClick="javascript:selectall('levelA')" value="全选/反选"
                                ...
                                <td class="td_l_c">
                                    <label><?php echo $row['name'] ?>
                                        <input type="checkbox" id="levelA" name="lever[]"
                                               value="<?php echo $row['id'] ?>" class="qxon"/>
                                    </label>
                                </td>
                                    ...
                                    foreach ($row['child'] as $arr2 => $row2) {
                                        ...
                                        <td class="td_l_c">
                                            <label><?php echo $row2['name'] ?>
                                                <input type="checkbox" id="levelA" name="lever[]"
                                                       value="<?php echo $row2['id'] ?>" class="qxon"/>
                                            </label>
                                        </td>
                                    <?php }
                                } ?>
