...
<form name="Save" id="Level" action="<?php echo site_url('role/add')?>" method="post" onSubmit="return CheckInput();">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
 ...
 <td class="td_l_l"><input name="right" type="text" class="int" id="lId" size="10" maxlength="3" onkeyup='this.value=this.value.replace(/\D/gi,"")' value="1" >
 ...
 <td class="td_l_l"><input name="name" type="text" class="int" id="lName" size="20" maxlength="16" value="总经理" ></td>
 </tr>
 ...
 <input type="checkbox" name="lever[]" value="<?php echo $row['id']?>" class="qxon"/></label></td>
 ...
 <input type="checkbox" id="levelA" name="lever[]" value="<?php echo $row['id']?>"  class="qxon"/>
 </label>
 </td>
 ...
 <input type="checkbox" id="levelA" name="lever[]" value="<?php echo $row2['id']?>"  class="qxon"/>
 </label>
 </td>
 <?php }}?>
 </tr>
 ...
 <tr>
 <td class="td_l_c"><label><?php echo $row['name']?>
 <input type="checkbox" id="levelB" name="lever[]" value="<?php echo $row['id']?>" class="qxon"/>
 </label></td>
 <!--<td class="td_l_c fontbold"><?php echo $row['name']?></td>-->
 ...
 <input type="checkbox" id="levelB" name="lever[]" value="<?php echo $row2['id']?>" class="qxon"/>
 </label></td>
 <?php }}?>
