...
<form name="Save" action="<?php echo site_url('product/edit')?>?id=<?php echo $id?>" method="post">
 ...
 if ($row['parentid']>0) {
 ?>
 <option value="<?php echo $row['name']?>" id="<?php echo $row['id']?>" <?php echo $row['name']==$strade ? 'selected' : ''?>><?php echo $row['name']?></option>
 <?php }}?> 
 </select>
 </span>
</td>
 ...
 <td class="td_l_l"><input name="title" type="text" id="pTitle" class="int" size="40" value="<?php echo $title?>" /></td>
 </tr>
 
 <tr>
 <td class="td_l_r title">规格</td>
 <td class="td_l_l"><input name="property1" type="text" id="cp_ziduan1" class="int" size="30" value="<?php echo $property1?>" /></td
>
 </tr>
 
 <tr>
 <td class="td_l_r title">型号</td>
 <td class="td_l_l"><input name="property2" type="text" id="cp_ziduan2" class="int" size="30" value="<?php echo $property2?>" /></td>
 </tr>
 
 <tr>
 <td class="td_l_r title">商品库存</td>
 <td class="td_l_l">
 <input name="qtys" type="text" id="cp_ziduan4" class="int" size="20" value="<?php echo $qtys?>" />
 当商品存库低于
 <input name="minqty" type="text" class="int" id="cp_ziduan3" value="10" size="10" value="<?php echo $minqty?>" />
 时告警！
 </td>
 </tr>
 ...
 <td class="td_l_l"><input name="purprice" type="text" id="cp_ziduan5" class="int" size="20" value="<?php echo $purprice?>" />
 元</td>
 </tr>
 
 <tr>
 <td class="td_l_r title">销售单价</td>
 <td class="td_l_l"><input name="saleprice" type="text" id="pUprice" class="int" size="20" value="<?php echo $saleprice?>" />
 元</td>
 </tr>
 </table></td>
 </tr>
