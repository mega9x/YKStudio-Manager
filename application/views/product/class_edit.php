...
<form name="Save" action="<?php echo site_url('product/class_edit')?>?id=<?php echo $id?>" method="post">
 ...
 <td class="td_r_l"><select name="parentid" class="int">
 ...
 <td class="td_l_l"><input name="name" type="text" id="pClassname" class="int" size="40"  value="<?php echo $name?>"/></td>
 </tr>
 </table></td>
 </tr>
 </table>
