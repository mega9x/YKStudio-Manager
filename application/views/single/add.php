...
<?php echo $name?> ( 编号 : <?php echo $id?> )
 ...
 &nbsp;
 <input name="Back" type="button" id="Back" class="btn1 btnxinz" value="新增" onclick='Linkmans_InfoAdd("<?php echo site_url('linkman/add')?>?id=<?php echo $id?>")'>
...
document.getElementById("linktel").innerHTML=" 电话：<b style='color:red;'>"+tel+"</b>";
 ...
 下次联系</li>
 <li class="w75">
  <input name="nexttime" type="text" id="rNextTime" class="int Wdate" size="22" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:00:00'})" />
 提前：
 <select name="remind">
