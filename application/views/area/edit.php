...
<body>
 ...
 <form name="Save" action="<?php echo site_url('area/edit')?>?id=<?php echo $id?>" method="post">
 ...
 <col width="100" />
 <tr class="tr_t"> 
 <td class="td_l_l" COLSPAN="2"><B>修改内容</B></td>
 </tr>
 <?php if ($parentid>0) {?>
 <tr> 
 ...
 <td class="td_l_l"><input name="name" type="text" id="aName" class="int" size="40" value="<?php echo $name?>" /></td>
