...
<span class="MenuboxS">
 ...
 <li class="hover"><span><a href="<?php echo site_url('customer/infoview')?>?id=<?php echo $id?>">任务资料</a></span></li>
 <?php }?>
...
="0" CLASS="table_1">
 ...
 <td class="td_l_r" COLSPAN="2" style="font-size:12px; line-height:18px;"><span class="Bottom_pd r fontnobold">录入时间：<?php echo $adddate?>  &nbsp;&nbsp;&nbsp;&nbsp;最近更新：<?php echo $lastupdtime?></span></td>
 </tr>
  
 <tr>
 <td class="td_l_r title">任务名称</td>
 <td class="td_r_l" colspan=3><strong><?php echo $name?></strong>&nbsp;&nbsp;<span >[未成交]</span></td>
 </tr>
 <tr>
 <td class="td_l_r title">账户信息</td>
 <td class="td_r_l" colspan=3><?php echo $area1?>&nbsp;&nbsp;<?php echo $area2?>&nbsp;&nbsp;<?php echo $address?></td>
 </tr>
 <tr>
 ...
 <td class="td_l_r title"  >电子邮件</td>
 <td class="td_r_l"  ><?php echo $email?></td>
 </tr>

 
 <tr>
 <td class="td_l_r title">备注</td>
 <td class="td_r_l"><?php echo $remark?></td>
 </tr>
 </table></td>
 </tr>
</table>
...
<script>function Kehu_InfoEdit() {$.dialog.open('<?php echo site_url('customer/edit')?>?id=<?php echo $id?>', {title: '编辑任务资料', width: 1000,height: 520, fixed: true}); };</script>
