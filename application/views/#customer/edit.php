...
="0" CLASS="table_1">
 ...
 邮编：
 <input name="Zip" type="text" class="int" id="Zip" size="10" maxlength="6" onkeyup='this.value=this.value.replace(/\D/gi,"")' value="<?php echo $zip?>">
 <span class="info_help help01" onMouseOver="tip.start(this)" title="限：数字">&nbsp;</span></td>
 </tr>
 <tr>
 ...
 合作站点</td>
 <td class="td_r_l" colspan="3"><input name="mobile" type="text" class="int" id="mobile" size="30" value="<?php echo $mobile?>" onkeyup='this.value=this.value.replace(/\D/gi,"")'>
 <span class="info_help help01" onMouseOver="tip.start(this)" title="限：数字">&nbsp;</span></td>
 </tr>
 <tr>
 <td class="td_l_r title"  >
