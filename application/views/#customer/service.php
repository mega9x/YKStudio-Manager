...
="0" CLASS="table_1">
 ...
 <script>function Kehu_InfoView<?php echo $row['cid']?>() {$.dialog.open('<?php echo site_url('customer/InfoView')?>?id=<?php echo $row['cid']?>', {title: '查看', width: 1200,height: 500, fixed: true}); };</script> 
 ...
 $.dialog.open('<?php echo site_url('service/del')?>?id=<?php echo $row['id']?>',{title: '删除原因', width: 400,height: 150, fixed: true}); 
...
<script>function Add() {$.dialog.open('<?php echo site_url('service/add')?>?id=<?php echo $id?>', {title: '新增售后', width: 800, height: 370,fixed: true}); };</script>
