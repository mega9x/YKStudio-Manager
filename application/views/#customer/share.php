...
<span class="MenuboxS">
 ...
 <li class="hover"><span><a href="<?php echo site_url('customer/share')?>?id=<?php echo $id?>">任务共享</a></span></li>
...
="0" CLASS="table_1">
 ...
 <td class="td_l_l red">
 <input type="radio" id="cShare" name="isshare" value= '0' <?php echo $isshare==0 ? 'checked' : ''?>  onClick="Setdisabled()">
 否　
 <input type="radio" id="cShare" name="isshare" value= '1' <?php echo $isshare==1 ? 'checked' : ''?> onClick="Setdisabled()">
 是</td>
 </tr>
 ...
 ?>
 <input type="checkbox"  id="cShareRange" name="sharerange[]" <?php echo in_array($row1['uid'],$sharerange) ? 'checked' : ''?> value="<?php echo $row1['uid']?>">
 <?php echo $row1['name']?>
 <?php }}?> 
 </td>
 </tr> 
...
<div class="fixed_bg_B">
 <table width="100%" border="0" cellpadding="0" cellspacing="0">
 <tr>
 <td valign="top" class="td_n Bottom_pd "><input  type="Submit" id="Back" class="btn2 btnbaoc" value="保存" onclick='Share_InfoSave()'>
