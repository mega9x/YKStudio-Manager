...
<script>function Setting_Expense() {$.dialog.open('<?php echo site_url('setting/config')?>?type=financier', {title: '自定义设置', width: 600, height: 350,fixed: true}); };</script>
<span class="MenuboxS">
 <ul>
 <?php 
...
="0" CLASS="table_1">
 ...
 <script>function Kehu_InfoView10() {$.dialog.open('save1.asp?action=Kehu&sType=InfoView&otype=Expense&cId=10', {title: '查看', width: 1220,height: 520, fixed: true}); };</script> 
...
<script>function Add_IN() {$.dialog.open('<?php echo site_url('financier/add')?>?outin=1&id=<?php echo $id?>', {title: '新增收入记录', width: 600, height: 400,fixed: true}); };</script>
<script>function Add_OUT() {$.dialog.open('<?php echo site_url('financier/add')?>?outin=2&id=<?php echo $id?>', {title: '新增支出记录', width: 600, height: 400,fixed: true}); };</script>
