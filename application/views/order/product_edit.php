...
<form name="Save" action="<?php echo site_url('order/product_edit') ?>?id=<?php echo $id ?>" method="post"
    ...
    <div class="cssout">
        ...
        <div class="cssin">
            <ul>
                ...
                <li class="w75">
                    <?php echo $protitle ?>
                    <input name="ProTitle" type="hidden" id="ProTitle" size="23" value="<?php echo $protitle ?>"
                           readonly/>
                ...
                <li class="w75">
                    <input name="ProNum" type="text" id="oProNum" size="10"
                           onChange="oMoney.value=oProPrice.value*parseInt(oProNum.value)-oDiscount.value"
                           value="<?php echo $pronum ?>" onFocus="if (value =='1'){value ='1'}"
                ...
                <li class="w75">
                    <input name="Discount" type="text" id="oDiscount" size="10"
                           onchange="oMoney.value=oProPrice.value*parseInt(oProNum.value)-oDiscount.value"
                           value="<?php echo $discount ?>" onfocus="if (value =='0'){value =''}"
                           onblur="if (value ==''){value='0'}"/>元
                </li>
                ...
                <li class="w75">
                    <input name="Money" type="text" id="oMoney" size="10" style="font-weight:bold;color:Red;" class=""
                           value="<?php echo $money ?>" onFocus="if (value =='0'){value =''}"
                           onblur="if (value ==''){value='0'}" readonly/>
                </li>
