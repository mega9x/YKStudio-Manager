...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <form name="Save" action="<?php echo site_url('order/audit') ?>?id=<?php echo $id ?>" method="post"
        ...
        <tr>
            <td valign="top" class="td_n pdl10 pdr10 pdt10"><textarea name="auditreason" rows="4" id="oAuditReasons"
                                                                      class="int"
                                                                      style="height:80px;width:98%;"><?php echo $auditreason ?></textarea>
            </td>
        </tr>
</table>
