    ...
    <div class="cssout">
        ...
        <div class="cssin">
            <ul>
                ...
                <li class="w75">
                    <input name="number" type="text" id="oCode" size="23" class="int"
                           value="<?php echo ODERNUMBER == 1 ? str_number('DD') : '' ?>" <?php echo ODERNUMBER == 1 ? 'readonly' : '' ?>
                           style="border:0;"/>
                ...
                <li class="w75">
                    <input name="edate" type="text" id="oEDate" class="int Wdate" size="15"
