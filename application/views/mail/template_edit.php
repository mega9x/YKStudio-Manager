...
<div class="mailpage">
 ...
 <form name="add" method="post" action="<?php echo site_url('mail/template_edit')?>?id=<?php echo $id?>" onSubmit='javascript:document.getElementById("t1").value = editor.html();return checkadd()'>
 ...
 <td class="td_r_l"><input name="type" type="text" class="int" id="leixing" size="80" value="<?php echo $type?>"></td>
 </tr>
 <tr class="tr">
 <td class="td_l_c title">邮件标题：</td>
 <td class="td_r_l"><input name="title" type="text" class="int" id="t0" size="80" value="<?php echo $title?>"></td>
 </tr>
 <tr class="tr">
 ...
 <textarea name="content" id="t1" style="width:99.6%;height:300px;">
<?php echo str_htmldecode($content)?>
</textarea></td>
 </tr>
 <tr class="tr">
