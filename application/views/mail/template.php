...
<!-- <td class="td_r_l title"><strong>发送次数</strong></td>-->
 ...
 <td class="td_r_l">
 <a href="<?php echo site_url('mail/template_edit')?>?id=<?php echo $row['id']?>" class="btn1 btnxiug">修改</a> 
 <a href="javascript:;" onclick="art.dialog({content: '是否确定删除？',icon: 'error',ok: function () {art.dialog.open('<?php echo site_url('mail/template_del')?>?id=<?php echo $row['id']?>');art.dialog.close();},cancelVal: '关闭',cancel: true })"  class="btn1 btnshanc">删除</a></td>
 </tr>
 <?php }?>
 </table>
</div>
