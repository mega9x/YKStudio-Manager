...
<div class="mailpage">
    ...
    <form name="add" method="post" action="<?php echo site_url('mail/add') ?>?id=<?php echo $id ?>"
          onSubmit='javascript:document.getElementById("txaContent").value = editor.html();return checkadd()'>
        <table width="100%" border="0" cellspacing="0" cellpadding="0" CLASS="table_1">
            ...
            <tr class="tr">
                ...
                <td class="td_r_l">
                    <input name="receive" type="text" class="int" id="receive"
                           value="<?php echo isset($email) ? $email : '' ?>" size="50"/>
                </td>
            </tr>
            ...
            <tr class="tr">
                ...
                <td class="td_r_l">
                    <?php foreach ($template as $arr => $row) { ?>
                        <input name="type" type="radio" class="noborder" value="<?php echo $row['title'] ?>"
                               data-labelauty="<?php echo $row['type'] ?>"
                               onClick="changenr('mb<?php echo $row['id'] ?>','<?php echo $row['title'] ?>')">
