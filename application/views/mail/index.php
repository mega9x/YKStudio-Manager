    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" CLASS="table_1">
        ...
        <?php foreach ($list as $arr => $row) { ?>
            <tr class="tr">
                ...
                <td class="td_r_c"><a href="javascript:;" class="btn1 btnshanc"
                                      onclick="art.dialog({content: '是否确定删除？',icon: 'error',ok: function () {art.dialog.open('<?php echo site_url('mail/del') ?>?id=<?php echo $row['id'] ?>');art.dialog.close();},cancelVal: '关闭',cancel: true })">删除</a>
                </td>
            </tr>
        <?php } ?>
        <!--<tr class="tr">
