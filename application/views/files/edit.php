...
<form name="Save" action="<?php echo site_url('files/edit') ?>?id=<?php echo $id ?>" method="post"
            ...
            <td valign="top" class="td_n pdl10 pdr10 pdt10">
                ...
                ="0" CLASS="table_1">
                    ...
                    <tr>
                        ...
                        <td class="td_r_l">
                            <input name="isshare" type="radio" class="noborder"
                                   value="1" <?php echo $isshare == 1 ? 'checked' : '' ?> data-labelauty="是">
                            <input name="isshare" type="radio" class="noborder"
                                   value="2" <?php echo $isshare == 2 ? 'checked' : '' ?> data-labelauty="否"></td>
                    </tr>
                    <tr>
