...
<script language="JavaScript">
 ...
 function CheckInput()
 {
 if(document.getElementById('s_class').value == ""){art.dialog({title: 'Error',time: 1,icon: 'warning'
,content: '未选择分类！'});document.getElementById('s_class').focus();return false;}
 if(document.getElementById('s_file').value == ""){art.dialog({title: 'Error',time: 1,icon: 'warning'
,content: '未选择要上传的附件！'});document.getElementById('s_file').focus();return false;}
 }
 -->
 
 </script>
<form name="Save" action="<?php echo site_url('files/add')?>" method="post" enctype="multipart/form-data" onSubmit="return CheckInput();">
...
="0" CLASS="table_1">
 ...
 <td class="td_r_l"><select name="class" id="Select_SoftClass">
 ...
 <td class="td_r_l">
 <input name="isshare" type="radio" class="noborder" value="1" data-labelauty="是"> 
 <input name="isshare" type="radio" class="noborder" value="2" checked data-labelauty="否"></td>
 </tr>
 <tr>
...
<input name="file" type="file" id="fFile" value="" class="int">
 ...
 <td class="td_r_l" style="padding:5px 10px;"><textarea name="content" rows="4" id="s_content" class
="int" style="height:50px;width:98%;"></textarea></td>
 </tr>
 </table></td>
 </tr>
...
<script>
 var oSel=document.getElementById('Select_SoftClass');
 var oOpn=oSel.options;
 oOpn[1].style.display='none';
 </script>
