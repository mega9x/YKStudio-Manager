...
<script language="JavaScript">
    ...
    function CheckInput() {
        if (document.getElementById('s_class').value == "") {
            art.dialog({
                title: 'Error', time: 1, icon: 'warning'
                , content: '未选择分类！'
            });
            document.getElementById('s_class').focus();
            return false;
        }
        if (document.getElementById('s_file').value == "") {
            art.dialog({
                title: 'Error', time: 1, icon: 'warning'
                , content: '未选择要上传的附件！'
            });
            document.getElementById('s_file').focus();
            return false;
        }
    }
...
<form name="Save" action="<?php echo site_url('files/add') ?>" method="post" enctype="multipart/form-data"
                ...
                ="0" CLASS="table_1">
                    ...
                    <tr>
                        ...
                        <td class="td_r_l">
                            ...
                            <input name="isshare" type="radio" class="noborder" value="2" checked data-labelauty="否">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="td_r_l" style="padding:5px 10px;"><textarea name="content" rows="4" id="s_content"
                                                                               class
                                                                               ="int"
