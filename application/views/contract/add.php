    ...
    <div class="cssout">
        ...
        <div class="cssin">
            <ul>
                ...
                <li class="w75">
                    <input name="number" type="text" id="hNum" size="23"
                           value="<?php echo CONTRACTNUMBER == 1 ? str_number('HT') : '' ?>" <?php echo CONTRACTNUMBER == 1 ? 'readonly' : '' ?>
                           style="border:0;" class="bor int"/>
                ...
                <li class="w75">
                    ...
                    <a class="btn1 btnxinz"
                       onclick='Select_Hetong("<?php echo site_url('select/main') ?>?type=hetong")'>新增</a>

                    <script>function Select_Hetong(Dourl) {
                ...
                <li class="w75">
                    ...
                    <input name="ordernumber" type="text" id="oCode" size="23" class="int" value=""
                           onclick='Choose_Order()'/>
                    <script>function Choose_Order() {
                            $.dialog.open('<?php echo site_url('common/choose_order')?>?customerid=<?php echo $id?>', {
                                title: '新窗口',
                                width: 900,
                                height: 480,
                                fixed: true
                ...
                <li class="w25">
                    <input name="sdate" type="text" id="hSdate" class="int Wdate" size="15"
                ...
                <li class="w25">
                    <input name="edate" type="text" id="hEdate" class="int Wdate" size="15"
                ...
                <li class="w25">
                    ...
                    <input type="text" id="qkMoney" type="hidden" name="qkmoney" class="int" size="10" readonly
                           value="0"/>
                    元
                </li>
                <li class="w25 bg tr">
                ...
                <li class="w25 bg" style="background:#fff;">
                    <select name="isinvoice" id="Select_YN">
                        <option value="">请选择</option>
                ...
                <li class="w25">
                    <select name="istax" id="Select_YN">
                        <option value="">请选择</option>
                        <option value="是">是</option>
                        <option value="否">否</option>
                    </select>
                ...
                <li class="w75 duohang">
                    <textarea name="content" rows="4" id="hContent" class="int"
                              style="height:80px;width:98%;"></textarea>
