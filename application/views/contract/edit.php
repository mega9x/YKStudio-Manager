...
<form name="Save" action="<?php echo site_url('contract/edit')?>?id=<?php echo $id?>" method="post" onSubmit="return CheckInput();">
...
="0" CLASS="table_1">
 ...
 <td class="td_r_l"><?php echo $number?> <span class="info_help help01" >&nbsp;不可修改</span></td>
 </tr>
 <tr>
 ...
 订单编号</td>
 <td class="td_r_l"><input name="orderid" type="hidden" id="oId" size="23" value="<?php echo $orderid?>" readonly />
 
 <input name="ordernumber" type="text" id="oCode" size="23" class="int" value="<?php echo $ordernumber?>" readonly />
 </td>
 </tr>
 <tr>
 <td class="td_l_r title">
 ...
 起始时间</td>
 <td class="td_r_l"><input name="sdate" type="text" id="hSdate" class="int Wdate" size="15" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="<?php echo $sdate?>" /></td>
 </tr>
 <tr>
 <td class="td_l_r title">
 <?php echo isset($config['bt_edate']) ? '<font color="#FF0000">*</font>' : ''?>
 到期时间</td>
 <td class="td_r_l"><input name="edate" type="text" id="hEdate" class="int Wdate" size="15" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="<?php echo $edate?>" /></td>
 </tr>
 <tr>
 <td class="td_l_r title">
 ...
 总金额</td>
 <td class="td_r_l">
     <input type="text" id="hMoney" name="money" class="int" size="10" value="<?php echo $money?>" readonly/>
 元
 </td>
         ...
         <tr>
             <td class="td_l_r title">
                 ...
                 欠款金额</td>
             <td class="td_r_l">
         <input type="text" id="qkMoney"  type="hidden" name="qkmoney" class="int"  value="<?php echo $qkmoney?>" size="10" readonly  value="0" />
             </td>
         </tr>
   <tr>
 <td class="td_l_r title">
 ...
 提供发票</td>
 <td class="td_r_l"><select name="isinvoice" id="Select_YN"><option value="">请选择</option>
 ...
 是否含税</td>
 <td class="td_r_l"><select name="istax" id="Select_YN"><option value="">请选择</option>
 ...
 详情备注</td>
 <td class="td_r_l" style="padding:5px 10px;"><textarea name="content" rows="4" id="hContent" class="int" style="height:80px;width:98%;"><?php echo $content?></textarea></td>
 </tr>
 </table></td>
 </tr>
 </table>
