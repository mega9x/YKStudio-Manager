...
<script language="JavaScript">
    ...
    function CheckInput() {
        if (document.all.rEdate.value == "") {
            art.dialog({
                title: 'Error', time: 1, icon: 'warning', content: '到期
                时间不能为空！'});document.all.rEdate.focus();return false;}
        }

    -->
</script>
<form name="Save" action="<?php echo site_url('contract/addrevenue') ?>?id=<?php echo $id ?>" method="post"
            ...
            <td valign="top" class="td_n pdl10 pdr10 pdt10">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" CLASS="table_1">
                    ...
                    <tr>
                        ...
                        <td class="td_r_l">
                            <input name="revenue" type="text" id="hRevenue" class="int" size="10" value="0"
                    ...
                    <tr>
                        ...
                        <td class="td_r_l" style="padding:5px 10px;">
                            <textarea name="content" rows="4" id="eContent" class="int"
                                      style="height:50px;width:95%;"></textarea></td>
                    </tr>
                </table>
            </td>
        </tr>
