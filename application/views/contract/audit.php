...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <form name="Save" action="<?php echo site_url('contract/audit') ?>?id=<?php echo $id ?>" method="post"
        ...
        <tr>
            <td valign="top" class="td_n pdl10 pdr10 pdt10"><textarea name="auditreasons" rows="4" id="hAuditReasons"
                                                                      class="int"
                                                                      style="height:80px;width:98%;"><?php echo $auditreasons ?></textarea>
            </td>
        </tr>
</table>
