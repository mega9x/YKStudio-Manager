...
<form name="Save" action="<?php echo site_url('report/edit')?>?id=<?php echo $id?>" enctype="multipart/form-data" method="post" onSubmit="javascript:document.getElementById('oReport').value = editor.html();">
...
<?php echo $title?> <a href="<?php echo site_url('report/down')?>?id=<?php echo $id?>">[下载附件]</a></td>
 </tr>
...
<textarea name="Reply" id="oReply" style="width:100%;height:400px;"><?php echo $reply?></textarea>
 </td>
 </tr>
