                     ...
                     <form name="searchForm" action="?Action=GendantoExcel" method="post">
                         <table width="100%" border="0" cellspacing="0" cellpadding="0" CLASS="table_1">
                             ...
                             <tr>
                                 ...
                                 <td class="td_r_l" style="border-top:0;"><select name="rType" id="Select_Gendan">
                                 ...
                                 <td class="td_r_l" style="border-top:0;"><select name="rState" id="Select_Type">
                                         <option value="">请选择</option>
                             ...
                             <tr>
                                 ...
                                 <td class="td_r_l" colspan=3>
                                     ...
                                     <input class="noborder" data-labelauty="跟单类型" type="checkbox"
                                            name="Exportitem3" value="1" checked>
                                     <input class="noborder" data-labelauty="跟单进度" type="checkbox"
                                            name="Exportitem4" value="1" checked>
                                     <input class="noborder" data-labelauty="跟单对象" type="checkbox"
                                            name="Exportitem5" value="1" checked>
                                     <input class="noborder" data-labelauty="下次联系" type="checkbox"
                                            name="Exportitem6" value="1" checked>
                                     <input class="noborder" data-labelauty="详细内容" type="checkbox"
