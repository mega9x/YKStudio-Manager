...
<body> 
 ...
 <li class="hover"><span><a href="<?php echo site_url('export/records')?>">跟单记录</a></span></li>
 ...
 <form name="searchForm" action="?Action=GendantoExcel" method="post">
 <table width="100%" border="0" cellspacing="0" cellpadding="0" CLASS="table_1">
 <col width="100" /><col width="220" /><col width="100" />
 <tr>
 <td class="td_l_c title" style="border-top:0;">跟单类型</td>
 <td class="td_r_l" style="border-top:0;"> <select name="rType" id="Select_Gendan"><option value="">请选择</option>
 <?php foreach($select_records as $arr=>$row) {?>
 <option value="<?php echo $row['name']?>" ><?php echo $row['name']?></option>
 <?php }?>
 
 </select></td>
 <td class="td_l_c title" style="border-top:0;">跟单进度</td>
 <td class="td_r_l" style="border-top:0;"> <select name="rState" id="Select_Type"><option value="">请选择</option><option value="已成交">已成交</option><option value="未成交">未成交</option><option value="跟进中">跟进中</option></select></td>
 </tr>
 <tr>
 ...
 <td class="td_r_l"> <input name="TimeBegin" type="text" id="TimeBegin" class="int Wdate" style="width:150px;" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" />&nbsp;~&nbsp;<input name="TimeEnd" type="text" id="TimeEnd" class="int Wdate" style="width:150px;" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" /></td>
 </tr>
 <tr>
 ...
 <input class="noborder" data-labelauty="跟单类型" type="checkbox" name="Exportitem3" value="1" checked>
 <input class="noborder" data-labelauty="跟单进度" type="checkbox" name="Exportitem4" value="1" checked>
 <input class="noborder" data-labelauty="跟单对象" type="checkbox" name="Exportitem5" value="1" checked>
 <input class="noborder" data-labelauty="下次联系" type="checkbox" name="Exportitem6" value="1" checked>
 <input class="noborder" data-labelauty="详细内容" type="checkbox" name="Exportitem7" value="1" checked>
