...
<body> 
 ...
 <td class="td_r_l" style="border-top:0;"> <select name='jinke_user' class='int'><option value="">请选择</option>
 ...
 <td class="td_r_l" style="border-top:0;border-right:0;"><select name='eOutIn' class="int" onChange="Show();"><option value="">请选择</option><option value="0">支出</option><option value="1">收入</option></select> 
 </td>
 <td class="td_r_l" style="border-top:0;">
 <span id=eTypeA STYLE="display:none;" ><select name="eTypeA" id="Select_ExpenseIN"><option value="">请选择</option><option value="订单预付款">订单预付款</option><option value="合同款">合同款</option><option value="维护费">维护费</option><option value="产品续费">产品续费</option><option value="其它">其它</option></select></span>
 <span id=eTypeB STYLE="display:none;"><select name="eTypeB" id="Select_ExpenseOUT"><option value="">请选择</option><option value="交通费">交通费</option><option value="通讯费">通讯费</option><option value="餐饮住宿">餐饮住宿</option><option value="赠送礼品">赠送礼品</option><option value="硬件采购">硬件采购</option><option value="其它">其它</option></select></span>
 </td>
 </tr>
 <tr>
 ...
 <input class="noborder" data-labelauty="收支日期" type="checkbox" name="Exportitem3" value="1" checked>
 <input class="noborder" data-labelauty="收入/支出" type="checkbox" name="Exportitem4" value="1" checked>
 <input class="noborder" data-labelauty="收支类别" type="checkbox" name="Exportitem5" value="1" checked>
 <input class="noborder" data-labelauty="总金额" type="checkbox" name="Exportitem6" value="1" checked>
 <input class="noborder" data-labelauty="详情备注" type="checkbox" name="Exportitem7" value="1" checked>
 <input class="noborder" data-labelauty="业务员" type="checkbox" name="Exportitem8" value="1" checked>
 <input class="noborder" data-labelauty="录入时间" type="checkbox" name="Exportitem9" value="1" checked>
 </td>
 </tr>
 </table> 
