                     ...
                     <form name="searchForm" action="?Action=ShouhoutoExcel" method="post">
                         <table width="100%" border="0" cellspacing="0" cellpadding="0" CLASS="table_1">
                             ...
                             <tr>
                                 ...
                                 <td class="td_r_l" style="border-top:0;"><select name="sType" id="Select_Shouhou">
                             ...
                             <tr>
                                 ...
                                 <td class="td_r_l" colspan=3>
                                     ...
                                     <input class="noborder" data-labelauty="相关产品" type="checkbox"
                                            name="Exportitem3" value="1" checked>
                                     <input class="noborder" data-labelauty="反馈主题" type="checkbox"
                                            name="Exportitem4" value="1" checked>
                                     <input class="noborder" data-labelauty="任务链接" type="checkbox"
                                            name="Exportitem5" value="1" checked>
                                     <input class="noborder" data-labelauty="反馈分类" type="checkbox"
                                            name="Exportitem6" value="1" checked>
                                     <input class="noborder" data-labelauty="反馈日期" type="checkbox"
                                            name="Exportitem7" value="1" checked>
                                     <input class="noborder" data-labelauty="结束日期" type="checkbox"
                                            name="Exportitem8" value="1" checked>
                                     <input class="noborder" data-labelauty="详情备注" type="checkbox"
                                            name="Exportitem9" value="1" checked>
                                     <input class="noborder" data-labelauty="是否解决" type="checkbox"
                                            name="Exportitem10" value="1" checked>
                                     <input class="noborder" data-labelauty="处理结果" type="checkbox"
                                            name="Exportitem11" value="1" checked>
                                     <input class="noborder" data-labelauty="业务员" type="checkbox" name="Exportitem12"
                                            value="1" checked>
