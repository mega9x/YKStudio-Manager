...
<body> 
 ...
 <li class="hover"><span><a href="<?php echo site_url('export/order')?>">订单记录</a></span></li>
 ...
 <tr>
 <td class="td_l_c title" style="border-top:0;">状态</td>
 <td class="td_r_l" style="border-top:0;"> <select name='oState' class="int"><option value="">请选择</option><option value="3">未处理</option><option value="2">处理中</option><option value="1">已完成</option></select></td>
 <td class="td_l_c title" style="border-top:0;">下单日期</td>
 ...
 <input class="noborder" data-labelauty="状态" type="checkbox" name="Exportitem9" value="1" checked>
 <input class="noborder" data-labelauty="订单编号" type="checkbox" name="Exportitem3" value="1" checked>
 <input class="noborder" data-labelauty="任务链接" type="checkbox" name="Exportitem4" value="1" checked>
 <input class="noborder" data-labelauty="下单日期" type="checkbox" name="Exportitem5" value="1" checked>
 <input class="noborder" data-labelauty="交单日期" type="checkbox" name="Exportitem6" value="1" checked>
 <input class="noborder" data-labelauty="预付款" type="checkbox" name="Exportitem7" value="1" checked>
 <input class="noborder" data-labelauty="订单金额" type="checkbox" name="Exportitem8" value="1" checked>
 <input class="noborder" data-labelauty="详情备注" type="checkbox" name="Exportitem10" value="1" checked>
 <input class="noborder" data-labelauty="业务员" type="checkbox" name="Exportitem11" value="1" checked>
 <input class="noborder" data-labelauty="录入时间" type="checkbox" name="Exportitem12" value="1" checked>
 </td>
 </tr>
 </table> 
