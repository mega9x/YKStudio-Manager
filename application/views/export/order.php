                     ...
                     <form name="searchForm" action="?Action=OrdertoExcel" method="post">
                         <table width="100%" border="0" cellspacing="0" cellpadding="0" CLASS="table_1">
                             ...
                             <tr>
                                 ...
                                 <td class="td_r_l" style="border-top:0;"><select name='oState' class="int">
                             ...
                             <tr>
                                 ...
                                 <td class="td_r_l" colspan=3>
                                     ...
                                     <input class="noborder" data-labelauty="状态" type="checkbox" name="Exportitem9"
                                            value="1" checked>
                                     <input class="noborder" data-labelauty="订单编号" type="checkbox"
                                            name="Exportitem3" value="1" checked>
                                     <input class="noborder" data-labelauty="任务链接" type="checkbox"
                                            name="Exportitem4" value="1" checked>
                                     <input class="noborder" data-labelauty="下单日期" type="checkbox"
                                            name="Exportitem5" value="1" checked>
                                     <input class="noborder" data-labelauty="交单日期" type="checkbox"
                                            name="Exportitem6" value="1" checked>
                                     <input class="noborder" data-labelauty="预付款" type="checkbox" name="Exportitem7"
                                            value="1" checked>
                                     <input class="noborder" data-labelauty="订单金额" type="checkbox"
                                            name="Exportitem8" value="1" checked>
                                     <input class="noborder" data-labelauty="详情备注" type="checkbox"
                                            name="Exportitem10" value="1" checked>
                                     <input class="noborder" data-labelauty="业务员" type="checkbox" name="Exportitem11"
                                            value="1" checked>
