                     ...
                     <form name="searchForm" action="?Action=HetongtoExcel" method="post">
                         <table width="100%" border="0" cellspacing="0" cellpadding="0" CLASS="table_1">
                             ...
                             <tr>
                                 ...
                                 <td class="td_r_l" style="border-top:0;"><select name="hType" id="Select_Hetong">
                             ...
                             <tr>
                                 ...
                                 <td class="td_r_l"><select name='hState' class="int">
                                         <option value="">请选择</option>
                                         <option value="待审">待审</option>
                                         <option value="合同有效">合同有效</option>
                                         <option value="合同无效">合同无效</option>
                                     </select></td>
                                 <td class="td_l_c title">到期时间</td>
                                 <td class="td_r_l"><input name="ETimeBegin" type="text" id="ETimeBegin"
                                                           class="int Wdate" style="width:100px;"
                                                           onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>&nbsp;~&nbsp;<input
                                             name="ETimeEnd" type="text" id="ETimeEnd" class="int Wdate"
                                             style="width:100px;"
                                             onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"/></td>
                             </tr>
                             <tr>
                                 ...
                                 <td class="td_r_l">
                                     <input name="hMoney" type="radio" class="noborder" data-labelauty="全部" value=""
                                            checked>
                                     <input name="hMoney" type="radio" class="noborder" data-labelauty="无欠款"
                                            value="0">
                                     <input name="hMoney" type="radio" class="noborder" data-labelauty="有欠款"
                                            value="1">
                                 </td>
                             </tr>
                             <tr>
                                 ...
                                 <td class="td_r_l" colspan=3>
                                     ...
                                     <input class="noborder" data-labelauty="订单编号" type="checkbox"
                                            name="Exportitem3" value="1" checked>
                                     <input class="noborder" data-labelauty="合同编号" type="checkbox"
                                            name="Exportitem4" value="1" checked>
                                     <input class="noborder" data-labelauty="起始时间" type="checkbox"
                                            name="Exportitem5" value="1" checked>
                                     <input class="noborder" data-labelauty="到期时间" type="checkbox"
                                            name="Exportitem6" value="1" checked>
                                     <input class="noborder" data-labelauty="合同分类" type="checkbox"
                                            name="Exportitem7" value="1" checked>
                                     <input class="noborder" data-labelauty="已收款" type="checkbox" name="Exportitem8"
                                            value="1" checked>
                                     <input class="noborder" data-labelauty="欠款" type="checkbox" name="Exportitem9"
                                            value="1" checked>
                                     <input class="noborder" data-labelauty="总金额" type="checkbox" name="Exportitem10"
                                            value="1" checked>
                                     <input class="noborder" data-labelauty="提供发票" type="checkbox"
                                            name="Exportitem11" value="1" checked>
                                     <input class="noborder" data-labelauty="是否含税" type="checkbox"
                                            name="Exportitem12" value="1" checked>
                                     <input class="noborder" data-labelauty="合同状态" type="checkbox"
                                            name="Exportitem13" value="1" checked>
                                     <input class="noborder" data-labelauty="详情备注" type="checkbox"
                                            name="Exportitem14" value="1" checked>
                                     <input class="noborder" data-labelauty="审核人员" type="checkbox"
                                            name="Exportitem15" value="1" checked>
                                     <input class="noborder" data-labelauty="审核时间" type="checkbox"
                                            name="Exportitem16" value="1" checked>
                                     <input class="noborder" data-labelauty="审核原因" type="checkbox"
                                            name="Exportitem17" value="1" checked>
                                     <input class="noborder" data-labelauty="业务员" type="checkbox" name="Exportitem18"
                                            value="1" checked>
                                     <input class="noborder" data-labelauty="录入时间" type="checkbox"
                                            name="Exportitem19" value="1" checked>
                                 </td>
                             </tr>
                         </table>
