...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
 <form name="Save" action="<?php echo site_url('service/audit')?>?id=<?php echo $id?>" method="post" onSubmit="return CheckInput();">
...
　
 ...
 <td class="td_r_l"><input name="edate" type="text" id="sEDate" class="int" size="15" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="<?php echo $edate?>"  /></td>
 </tr>
 <tr>
 <td class="td_l_r title">处理结果</td>
 <td class="td_r_l" style="padding:5px 10px;">
 <textarea name="info" rows="4" id="sInfo" class="int" style="height:50px;width:98%;"  ><?php echo $info?></textarea></td>
 </tr>
 </table></td>
 </tr>
</table>
