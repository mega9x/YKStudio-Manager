                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_1">
                    ...
                    <tr>
                        ...
                        <td class="td_r_l">
                            ...
                            <input name="Chongxuan" type="button" id="Chongxuan" class="btn1 btnchongx" value="重选"
                                   onclick='$.dialog .open.origin.InfoAdd_Chose();$.dialog.close();'>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="td_r_l">
                            <input name="sdate" type="text" id="sSDate" class="Wdate int" size="15"
                                   onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="<?php echo date('Y-m-d') ?>"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="td_l_r title">
                        ...
                        <td class="td_r_l" style="padding:5px 10px;">
                            <textarea name="content" rows="4" id="sContent" class="int"
                    ...
                    <tr>
                        ...
                        <td class="td_r_l">
                            <input name="edate" type="text" id="sEDate" class="int" size="15"
                                   onfocus="WdatePicker ({dateFmt:'yyyy-MM-dd'})" value="" readonly="readonly"
                                   disabled="disabled"/>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="td_r_l" style="padding:5px 10px;">
                            <textarea name="info" rows="4" id="sInfo" class="int" style="height:50px;width:98%;"
