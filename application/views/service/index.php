...
<script>function ChoseOK(i) {
        {
            $.dialog.open('<?php echo site_url('service/add')?>?id=' + i, {
                title: '新增售后【第二步：录入售后信息】',
                width: 600,
                height: 500,
                fixed: true
            });
                                    ...
                                    <tr>
                                        ...
                                        <td class="td_r_l">
                                            ...
                                            <select name='issolve'>
                                                ...
                                                <option value="1" <?php echo $issolve == 1 ? 'selected' : '' ?>>未解决
                                                </option>
                                                <option value="2" <?php echo $issolve == 2 ? 'selected' : '' ?>>已解决
                                                </option>
                                            </select>
                                            ...
                                            <input type="button" class="btn1 btnxiug" value="导出"
                                                   onClick=window.location.href="<?php echo site_url('service/excel') ?>?<?php echo $parameter ?>"/>
                                        </td>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_1">
                    ...
                    <?php foreach ($list as $arr => $row) { ?>
                        <tr class="tr">
                            ...
                            <td class="td_l_l"><a onclick='Kehu_InfoView<?php echo $row['customerid'] ?>()'
                        ...
                        <script>function Kehu_InfoView<?php echo $row['customerid']?>() {
                                $.dialog.open('<?php echo site_url('customer/service')?>?id=<?php echo $row['customerid']?>', {
                                    title: '查看',
                                    width: 1200,
                                    height: 500,
                                    fixed: true
