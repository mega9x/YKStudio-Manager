...
<?php if ($this->input->get('act')) { ?>
    <script>swal("保存成功", "3秒后自动关闭", "success");
        setTimeout("this.location.href='<?php echo site_url('theme')?>'", 3000);</script>
<?php } ?>
<span class="MenuboxS">
 <ul>
 <li class="hover"><span><a href="<?php echo site_url('theme/add') ?>">主题上传</a></span></li>
...
<div class="allpage">
    ...
    <form action="<?php echo site_url('theme/add') ?>" name="Themeadd" method="post"
          onSubmit="return CheckFormThemeadd();">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" CLASS="table_1">
            ...
            <tr class="tr">
                ...
                <td colspan="2" class="td_r_l"><input name="name" type="text" id="tname" class="int" value="" size
                    ="35"></td>
            </tr>
            <tr class="tr">
                <td nowrap="nowrap" class="td_l_r title">缩略图</td>
                <td valign="middle" class="td_r_l"><input name="smallpic" type="text" id="tsmallpic" class="int" value
                    ="" size="35">
                    <input type="button" id="image1" value="选择图片"/>
                    尺寸：140*100px
                </td>
                <td valign="middle" class="td_r_l"><img src='' width="140" height="100" style="margin:10px 0 10px 0;"
                                                        id="pic1"/></td>
            </tr>
            <tr class="tr">
                <td nowrap="nowrap" class="td_l_r title">主题大图</td>
                <td class="td_r_l">
                    <input name="bigpic" type="text" id="tbigpic" class="int" value="" size="35">
                    <input type="button" id="image3" value="选择图片"/>
                    尺寸：1920*1080px
                </td>
                <td class="td_r_l"><img src='' width="140" height="100" style="margin:10px 0 10px 0;" id="pic2"/></td>
            </tr>
        </table>
        <div class="h50b"></div>
