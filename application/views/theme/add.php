...
function CheckFormThemeadd()
{
 ...
 <form action="<?php echo site_url('theme/add')?>" name="Themeadd" method="post" onSubmit="return CheckFormThemeadd();">
...
="" size="35">
 ...
 尺寸：140*100px </td>
 <td valign="middle" class="td_r_l"><img src='' width="140" height="100" style="margin:10px 0 10px 0;" id="pic1"/></td>
 </tr>
 <tr class="tr">
