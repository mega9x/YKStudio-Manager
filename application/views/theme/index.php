...
<div class="allpage">
 ...
 <?php if($row['uid']>0) {?>
 <div class="theme_text"><span style="font-weight:bold;"><?php echo $row['name']?></span> <span style=" margin-left:20px;"><a href="<?php echo site_url('theme/edit')?>?id=<?php echo $row['id']?>">修改</a> <a href="<?php echo site_url('theme/del')?>?id=<?php echo $row['id']?>">删除</a></span></div>
 <?php } else {?>
 <div class="theme_text" style="color:#717273;"><span style="font-weight:bold;"><?php echo $row['name']?></span> <span style=" margin-left:20px;">[系统壁纸]</span></div>
 <?php }?>
