...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td valign="top" class="td_n pdl10 pdr10 pdt10">
            ...
            <form name="newUser" id="newUser" action="<?php echo site_url('user/info') ?>" method="post"
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" CLASS="table_1">
                    ...
                    <tr>
                        ...
                        <td class="td_l_l"><input name="userpwd" type="password" class="int" id="password" size="20"
                                                  maxlength="16" selfValue=""
                                                  style="background:#F1F1F1;cursor:not-allowed;">
                            不修改密码请留空！
                        </td>
                        <td class="td_l_c title">重复密码</td>
                        <td class="td_l_l"><input name="confirmpwd" type="password" class="int" id="confirmPWS"
                                                  size="20" maxlength="16" selfValue=""
                                                  style="background:#F1F1F1;cursor:not-allowed;"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="td_l_l"><input name="birthday" type="text" id="Birthday" class="int Wdate"
                                                  value="<?php echo $birthday ?>" size="20" onFocus="WdatePicker()">
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="td_l_l"><input name="mobile" type="text" class="int" id="Mobile"
                                                  value="<?php echo $mobile ?>" size="30" maxlength="16"></td>
                        <td class="td_l_c title">E-mail</td>
                        <td class="td_l_l"><input name="email" type="text" class="int" id="Email"
                                                  value="<?php echo $email ?>" size="30"/></td>
                    </tr>
 ...
 <input type="button" id="upavatar" class="btnupload" value="选择文件">
     ...
     -->
                    ...
                    <tr>
                        ...
                        <td class="td_l_l"><input name="sign" type="text" class="int" id="sign" size="45"
                    ...
                    <tr>
                        ...
                        <td class="td_l_l">
                            <input name="sex" type="radio" class="noborder"
                                   value="1" <?php echo $sex == 1 ? 'checked' : '' ?> data-labelauty="男">
                            <input name="sex" type="radio" class="noborder"
                                   value="2" <?php echo $sex == 2 ? 'checked' : '' ?> data-labelauty="女">
                    ...
                    <tr>
                        ...
                        <td colspan="3" class="td_l_l" style=" padding-top:10px; padding-bottom:10px;">
                            <textarea name="info" cols="80" rows="4" id="uinfo"
                                      style="width:98%;"><?php echo $info ?></textarea>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3" class="td_r_l" style=" padding-top:10px; padding-bottom:10px;">
                            <label class="vtip"
                                   title="<img src='<?php echo base_url() ?>theme/windows/images/icon1.png' width='300' />">
                                <input type="radio" name="icon" value="1" <?php echo $icon == 1 ? 'checked' : '' ?>
                                       data-labelauty="风格1">

                            </label>

                            <label class="vtip"
                                   title="<img src='<?php echo base_url() ?>theme/windows/images/icon2.png' width='300' />">
                                <input type="radio" name="icon" value="2" <?php echo $icon == 2 ? 'checked' : '' ?>
                                       data-labelauty="风格2">
                            </label>
                        </td>
                    </tr>
                ...
                <div class="fixed_bg_B">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td valign="top" class="td_n Bottom_pd "><input type="submit" class="btn2 btnbaoc"
                                                                            value="保存修改"></td>
                        </tr>
                    </table>
                </div>
