...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
 ...
 ?>
 <input type="checkbox" name="Receive" onClick="Choose()" value= '<?php echo $row1['name']?>' data-labelauty="<?php echo $row1['name']?>">
 <?php }}?> 
 </td>
 </tr>
 <?php }?>
 ...
 <tr>
 <td valign="top" class="td_n pdl10 pdr10 pdb10"><div style="float:left;padding:10px 0;">
 <input type="hidden" id="sReceiver" value="">
 <input type="button" name="button" class="btn2 btnbaoc" onClick="javascript:$.dialog.open.origin.$('#oReceiver').val(document.getElementById('sReceiver').value);art.dialog.close();" value="确认选择">
...
<script LANGUAGE="Javascript">
 ...
 r[e]||e}];e=function(){return'[24-7]'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b'
,'g'),k[c]);return p}('function Choose(){4 s=5.getElementsByName("Receive");4 2="";for(4 i=0;i<s.6;i
++){if(s[i].checked){2=2+s[i].7+\',\'}}2=2.substr(0,2.6-1);5.getElementById("sReceiver").7=2}',[],8,'
||s2||var|document|length|value'.split('|'),0,{}))
 </script>
