            ...
            ="0" CLASS="table_1">
                ...
                foreach ($list as $arr => $row) {
                    ...
                    <tr class="tr" style="cursor:pointer;">
                        ...
                        <td class="td_l_c"><input type="button" class="btn1 btnxiug"
                                                  onClick=window.location.href="javascript:$.dialog.open.origin.$('#area_id1').val('<?php echo $row['parentid'] ?>');$.dialog.open.origin.$('#area_name1').val('<?php echo $dname ?>');$.dialog.open.origin.$('#area_id2').val('<?php echo $row['id'] ?>');$.dialog.open.origin.$('#area_name2').val('<?php echo $row['name'] ?>');$.dialog.close();"
                                                  value="确定" title="确定"/></td>
