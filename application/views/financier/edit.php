...
<form name="Save" action="<?php echo site_url('financier/edit') ?>?id=<?php echo $id ?>" method="post"
...
({dateFmt:'yyyy-MM-dd'})" value="<?php echo $edate ?>"/></td>
                    ...
                    <tr>
                        ...
                        <td class="td_r_l"><select name="type" id="Select_ExpenseIN">
                    ...
                    <tr>
                        ...
                        <td class="td_r_l"><input name="money" type="text" id="eMoney" class="int" size="10"
                    ...
                    <tr>
                        ...
                        <td class="td_r_l" colspan=3 style="padding:5px 10px;">
                            <textarea name="content" rows="4" id="eContent" class="int"
                                      style="height:80px;width:99%;"><?php echo $content ?></textarea></td>
                    </tr>
                </table>
            </td>
        </tr>
