...
="0" CLASS="table_1">
 ...
 收支日期</td>
 <td class="td_r_l"><input name="edate" type="text" id="eDate" class="Wdate int" size="15" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="<?php echo date('Y-m-d')?>" /></td>
 </tr>
 <tr>
 <td class="td_l_r title">
 ...
 <td class="td_r_l"><select name="type" id="Select_ExpenseOUT"><option value="">请选择</option>
 ...
 总金额</td>
 <td class="td_r_l"><input name="money" type="text" id="eMoney" class="int" size="10" value="0" onFocus="if (value =='0'){value =''}"onblur="if (value ==''){value='0'}" />
 元</td>
 </tr>
 <tr>
 <td class="td_l_r title">
 ...
 详情备注</td>
 <td class="td_r_l" colspan=3 style="padding:5px 10px;"><textarea name="content" rows="4" id="eContent" class="int" style="height:80px;width:99%;"></textarea></td>
 </tr>
 <?php if ($id<1) {?>
 <tr>
 <td valign="middle" class="td_l_r title">操作说明</td>
 <td class="td_r_l" colspan=3 style=" line-height:22px;">此处添加的财务记录不与任务关联，如需添加与任务关联的财务记录，操作方式：<br /><span
 style="color:red;">桌面 - 任务管理 - 点击任务名称 - 收支记录 - 新增收入/支出</span></td>
 </tr>
 <?php }?>
 </table></td>
 </tr>
