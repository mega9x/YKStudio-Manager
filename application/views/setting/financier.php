...
<form name="Save" action="<?php echo site_url('setting/config')?>?type=financier" method="post"onSubmit="return CheckInput
();">
...
="0" CLASS="table_1">
 ...
 <tr>
 <td class="td_l_c"><label>收支日期
 <input name="edate" type="checkbox" id="date" value="1" <?php echo isset($value['edate']) ? 'checked' : ''?> class="okon"/>
 </label></td>
 <td class="td_l_c"><label>收入/支出
 <input name="outin" type="checkbox" id="outin" value="1" <?php echo isset($value['outin']) ? 'checked' : ''?> class="okon"/>
 </label></td>
 <td class="td_l_c"><label>收支类别
