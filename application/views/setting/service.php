                ...
                ="0" CLASS="table_1">
                    ...
                    <tr>
                        <td class="td_l_c"><label>任务名称
                                <input name="customername" type="checkbox" id="sh_proid"
                                       value="1" <?php echo isset($value['customername']) ? 'checked' : '' ?>
                                       class="okon"/>
                            </label></td>
                        <td class="td_l_c"><label>反馈主题
                                <input name="title" type="checkbox" id="title"
                                       value="1" <?php echo isset($value['title']) ? 'checked' : '' ?> class="okon"/>
                            </label></td>
                    ...
                    <tr>
                        ...
                        <td class="td_l_c"><label>是否解决
                                <input name="solve" type="checkbox" id="solve"
                                       value="1" <?php echo isset($value['solve']) ? 'checked' : '' ?> class="okon"/>
                            </label></td>
                        <td class="td_l_c"><label>处理结果
                                <input name="info" type="checkbox" id="info"
                                       value="1" <?php echo isset($value['info']) ? 'checked' : '' ?> class="okon"/>
                            </label></td>
                    </tr>
                    <tr>
        ...
        <tr>
            <td valign="top" class="td_n pdl10 pdr10 pdt10">
                ...
                ="0" CLASS="table_1">
                    ...
                    <tr>
                        <td class="td_l_c"><label>任务名称
                                <input name="bt_customername" type="checkbox" id="bt_customername"
                                       value="1" <?php echo isset($value['bt_customername']) ? 'checked' : '' ?>
                                       class="okon_bt"/>
                            </label></td>
                        <td class="td_l_c"><label>反馈主题
                                <input name="bt_title" type="checkbox" id="bt_title"
                                       value="1" <?php echo isset($value['bt_title']) ? 'checked' : '' ?>
                                       class="okon_bt"/>
                            </label></td>
                        <td class="td_l_c"><label>反馈分类
