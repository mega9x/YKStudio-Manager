...
<form name="Save" action="<?php echo site_url('setting/config')?>?type=customer" method="post"onSubmit="return CheckInput();">
 <table width="100%" border="0" cellpadding="0" cellspacing="0">
 <tr>
 <td valign="top" class="td_n pdl10 pdr10 pdt10"><table width="100%" border="0" cellspacing="0" cellpadding="0" CLASS="table_1 x-choose">
 <!--<col width="50" />-->
 <col width="25%" />
 <col width="25%" />
 <col width="25%" />
 ...
 <input name="area" type="checkbox" id="area" value="1" <?php echo isset($value['area']) ? 'checked' : ''?> class="okon"/>
 </label></td>
 <td class="td_l_c"><label>账户信息
 <input name="address" type="checkbox" id="address" value="1" <?php echo isset($value['address']) ? 'checked' : ''?> class="okon"/>
 </label></td>
 </tr>
 <tr>
 ...
 <input name="start" type="checkbox" id="start" value="1" <?php echo isset($value['start']) ? 'checked' : ''?> class="okon"/>
 </label>
 </td>
 <td class="td_l_c"><label>所属联盟
 <input name="source" type="checkbox" id="source" value="1" <?php echo isset($value['source']) ? 'checked' : ''?> class="okon"/>
 </label>
 </td>
     <td class="td_l_c"><label>任务代码
             <input name="record" type="checkbox" id="record" value="1" <?php echo isset($value['record']) ? 'checked' : ''?> class="okon"/>
         </label>
     </td>
 </tr>
 ...
 <input name="adddate" type="checkbox" id="adddate" value="1" <?php echo isset($value['adddate']) ? 'checked' : ''?> class="okon"/>
 </label></td>

 <td class="td_l_c"><label>下次跟进
 <input name="nexttime" type="checkbox" id="nexttime" value="1" <?php echo isset($value['nexttime']) ? 'checked' : ''?> class="okon"/>
 </label></td>
  
 </tr>
 <tr>
 <td class="td_l_c"><label>任务类型
 <input name="trade" type="checkbox" id="trade" value="1" <?php echo isset($value['trade']) ? 'checked' : ''?> class="okon"/>
 </label></td>
 
 <td class="td_l_c"><label>业务员
 <input name="adduser" type="checkbox" id="adduser" value="1" <?php echo isset($value['adduser']) ? 'checked' : ''?> class="okon"/>
 </label></td>
 <td class="td_l_c">&nbsp;</td>
 </tr>
 </table>
