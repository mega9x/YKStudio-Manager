...
="0" CLASS="table_1">
 ...
 <input name="number" type="checkbox" id="number" value="1" <?php echo isset($value['number']) ? 'checked' : ''?> class="okon"/>
 </label></td>
 <td class="td_l_c"><label>订单编号
 <input name="ordernumber" type="checkbox" id="ordernumber" value="1" <?php echo isset($value['ordernumber']) ? 'checked' : ''?> class="okon"/>
 </label></td>
 ...
 <input name="money" type="checkbox" id="money" value="1" <?php echo isset($value['money']) ? 'checked' : ''?> class="okon"/>
 </label></td>
 <td class="td_l_c"><label>已收款
 <input name="yjmoney" type="checkbox" id="revenue" value="1" <?php echo isset($value['yjmoney']) ? 'checked' : ''?> class="okon"/>
 </label></td>
 <td class="td_l_c"><label>欠款
 <input name="qkmoney" type="checkbox" id="qkmoney" value="1" <?php echo isset($value['qkmoney']) ? 'checked' : ''?> class="okon"/>
 </label></td>
 </tr>
 <tr>
 <td class="td_l_c"><label>提供发票
 <input name="invoice" type="checkbox" id="invoice" value="1" <?php echo isset($value['invoice']) ? 'checked' : ''?> class="okon"/>
 </label></td>
 <td class="td_l_c"><label>是否含税
 <input name="tax" type="checkbox" id="tax" value="1" <?php echo isset($value['tax']) ? 'checked' : ''?> class="okon"/>
 </label></td>
 <td class="td_l_c"><label>审核人员
 <input name="audit" type="checkbox" id="audit" value="1" <?php echo isset($value['audit']) ? 'checked' : ''?> class="okon"/>
 </label></td>
 <td class="td_l_c"><label>审核时间
 <input name="audittime" type="checkbox" id="auditTime" value="1" <?php echo isset($value['audittime']) ? 'checked' : ''?> class="okon"/>
 </label></td>
 </tr>
 <tr>
...
="0" CLASS="table_1">
 ...
 <tr>
 <td class="td_l_c"><label>订单编号
 <input name="bt_ordernumber" type="checkbox" id="bt_ordernumber" value="1" <?php echo isset($value['bt_ordernumber']) ? 'checked' : ''?> class="okon_bt"/>
 </label></td>
 <td class="td_l_c"><label>起始时间
 ...
 <tr>
 <td class="td_l_c"><label>总金额
 <input name="bt_money" type="checkbox" id="bt_money" value="1" <?php echo isset($value['bt_money']) ? 'checked' : ''?> class="okon_bt"/>
 </label></td>
 <td class="td_l_c"><label>已收款
 <input name="bt_revenue" type="checkbox" id="bt_revenue" value="1" <?php echo isset($value['bt_revenue']) ? 'checked' : ''?> class="okon_bt"/>
 </label></td>
 <td class="td_l_c"><label>提供发票
 <input name="bt_invoice" type="checkbox" id="bt_invoice" value="1" <?php echo isset($value['bt_invoice']) ? 'checked' : ''?> class="okon_bt"/>
 </label></td>
