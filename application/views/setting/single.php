...
<form name="Save" action="<?php echo site_url('setting/config')?>?type=single" method="post" onSubmit="return CheckInput();">
...
>
 ...
 <input name="bt_nexttime" type="checkbox" id="bt_nexttime" value="1" <?php echo isset($value['bt_nexttime']) ? 'checked' : ''?> class="okon_bt"
/>
 </label></td>
 </tr>
 <tr>
