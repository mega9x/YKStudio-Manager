...
<form name="Save" action="<?php echo site_url('setting/config') ?>?type=single" method="post"
        ...
        <tr>
            <td valign="top" class="td_n pdl10 pdr10 pdt10">
                ...
                ="0" CLASS="table_1">
                    ...
                    <tr>
                        <td class="td_l_c"><label>跟单类型
                                <input name="bt_type" type="checkbox" id="bt_type"
                                       value="1" <?php echo isset($value['bt_type']) ? 'checked' : '' ?>
                                       class="okon_bt"/>
                            </label></td>
                        <td class="td_l_c"><label>跟单进度
                                <input name="bt_state" type="checkbox" id="bt_state"
                                       value="1" <?php echo isset($value['bt_state']) ? 'checked' : '' ?>
                                       class="okon_bt"/>
                            </label></td>
                        <td class="td_l_c"><label>跟单对象
                                <input name="bt_linkman" type="checkbox" id="bt_linkman"
                                       value="1" <?php echo isset($value['bt_linkman']) ? 'checked' : '' ?>
                                       class="okon_bt"/
                                >
                            </label></td>
                        <td class="td_l_c"><label>下次联系
                                <input name="bt_nexttime" type="checkbox" id="bt_nexttime"
                                       value="1" <?php echo isset($value['bt_nexttime']) ? 'checked' : '' ?>
                                       class="okon_bt"
                                />
                            </label></td>
                    </tr>
                    <tr>
                        <td class="td_l_c"><label>详细内容
                                <input name="bt_content" type="checkbox" id="bt_content"
                                       value="1" <?php echo isset($value['bt_content']) ? 'checked' : '' ?>
                                       class="okon_bt"/
                                >
                            </label></td>
                        <td colspan="3" class="td_l_c"></td>
                    </tr>
                </table>
