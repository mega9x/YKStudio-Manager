...
<form name="Save" action="<?php echo site_url('setting/config') ?>?type=order" method="post"
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" CLASS="table_1">
                    ...
                    <tr>
                        ...
                        <td colspan="1" class="td_l_c"><label>预付款
                                <input name="deposit" type="checkbox" id="deposit"
                                       value="1" <?php echo isset($value['deposit']) ? 'checked' : '' ?> class="okon"/>
                            </label></td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="1" class="td_l_c"><label>业务员
                                <input name="user" type="checkbox" id="user"
                                       value="1" <?php echo isset($value['user']) ? 'checked' : '' ?> class="okon"/>
                            </label></td>
                        <td colspan="1" class="td_l_c"><label>录入时间
                                <input name="time" type="checkbox" id="time"
                                       value="1" <?php echo isset($value['time']) ? 'checked' : '' ?> class="okon"/>
                            </label></td>
                    </tr>
                </table>
                ...
                ="0" CLASS="table_1">
                    ...
                    <tr>
                        ...
                        <td class="td_l_c"><label>预付款
                                <input name="bt_deposit" type="checkbox" id="bt_deposit"
                                       value="1" <?php echo isset($value['bt_deposit']) ? 'checked' : '' ?>
                                       class="okon_bt"/>
                            </label></td>
                    </tr>
                    <tr>
