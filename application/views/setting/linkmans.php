...
="0" CLASS="table_1">
 ...
 <input name="name" type="checkbox" id="name" value="1" <?php echo isset($value['name']) ? 'checked' : ''?> class="okon"/>
 </label></td>
 <td class="td_l_c"><label>性别
 <input name="sex" type="checkbox" id="sex" value="1" <?php echo isset($value['sex']) ? 'checked' : ''?> class="okon"/>
 </label></td>
 <td class="td_l_c"><label>任务链接
 <input name="job" type="checkbox" id="job" value="1" <?php echo isset($value['job']) ? 'checked' : ''?> class="okon"/>
 </label></td>
 <td class="td_l_c"><label>合作站点
 <input name="mobile" type="checkbox" id="mobile" value="1" <?php echo isset($value['mobile']) ? 'checked' : ''?> class="okon"/>
 </label></td>
 </tr>
 <tr>
 <td class="td_l_c"><label>联系电话
 <input name="tel" type="checkbox" id="tel" value="1" <?php echo isset($value['tel']) ? 'checked' : ''?> class="okon"/>
 </label></td>
 <td class="td_l_c"><label>电子邮件
 <input name="email" type="checkbox" id="email" value="1" <?php echo isset($value['email']) ? 'checked' : ''?> class="okon"/>
 </label></td>
 <td class="td_l_c"><label>腾讯QQ
 <input name="qq" type="checkbox" id="qq" value="1" <?php echo isset($value['qq']) ? 'checked' : ''?> class="okon"/>
 </label></td>
 <td class="td_l_c"><label>MSN
 <input name="msn" type="checkbox" id="msn" value="1" <?php echo isset($value['msn']) ? 'checked' : ''?> class="okon"/>
 </label></td>
 </tr>
 <tr>
 <td class="td_l_c"><label>阿里旺旺
 <input name="alww" type="checkbox" id="alww" value="1" <?php echo isset($value['alww']) ? 'checked' : ''?> class="okon"/>
 </label></td>
 <td class="td_l_c"><label>生日
 <input name="birthday" type="checkbox" id="birthday" value="1" <?php echo isset($value['birthday']) ? 'checked' : ''?> class="okon"/>
 </label></td>
...
="0" CLASS="table_1">
 ...
 <input name="bt_sex" type="checkbox" id="bt_sex" value="1" <?php echo isset($value['bt_sex']) ? 'checked' : ''?> class="okon_bt"/>
 </label></td>
...
>
 ...
 <tr>
 <td class="td_l_c"><label>联系电话
 <input name="bt_tel" type="checkbox" id="bt_tel" value="1" <?php echo isset($value['bt_tel']) ? 'checked' : ''?> class="okon_bt"/>
 </label></td>
 ...
 <input name="bt_msn" type="checkbox" id="bt_msn" value="1"  <?php echo isset($value['bt_msn']) ? 'checked' : ''?> class="okon_bt"/>
 </label></td>
 </tr>
 <tr>
 <td class="td_l_c"><label>阿里旺旺
 <input name="bt_alww" type="checkbox" id="bt_alww" value="1" <?php echo isset($value['bt_alww']) ? 'checked' : ''?>  class="okon_bt"/>
 </label></td>
 <td colspan="1" class="td_l_c"><label>生日
 <input name="bt_birthday" type="checkbox" id="bt_birthday" value="1" <?php echo isset($value['bt_birthday']) ? 'checked' : ''?>  class="okon_bt"/>
 </label></td>
