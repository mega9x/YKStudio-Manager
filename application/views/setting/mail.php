        ...
        <form name="mailset" method="post" action="<?php echo site_url('setting/mail') ?>">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" CLASS="table_1">
                ...
                <tr class="tr">
                    ...
                    <td class="td_r_l"><input name="mail_smtp" type="text" class="int" id="t0" size="40"
                                              value="<?php echo MAIL_SMTP ?>"></td>
                    <td class="td_l_c title">端口</td>
                    <td class="td_r_l"><input name="mail_port" type="text" class="int" id="E_Port" size="40"
                                              value="<?php echo MAIL_PORT ?>"/></td>
                </tr>
                <tr class="tr">
                    <td class="td_l_c title">发件箱：</td>
                    <td class="td_r_l"><input name="mail_user" type="text" class="int" id="t1" size="40"
                                              value="<?php echo MAIL_USER ?>"/></td>
                    <td class="td_l_c title">密码：</td>
                    <td class="td_r_l"><input name="mail_pwd" type="password" class="int" id="t2" size="40"
                                              value="<?php echo MAIL_PWD ?>"/></td>
                </tr>
                <tr class="tr">
                    <td class="td_l_c title">显示邮箱：</td>
                    <td class="td_r_l"><input name="mail_admin" type="text" class="int" id="t3" size="40"
                                              value="<?php echo MAIL_ADMIN ?>"/></td>
                    <td class="td_l_c title">发件者名称：</td>
                    <td class="td_r_l"><input name="mail_name" type="text" class="int" id="t4" size="40"
                                              value="<?php echo MAIL_NAME ?>"/></td>
                </tr>
            </table>
            <div class="h50b"></div>
