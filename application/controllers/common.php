...
class Common extends CI_Controller {
	...
	public function choose_product(){
        $post = array('keyword','bigclass','smallclass');
        foreach($post as $key=>$val) {
            $data[$val] = str_htmlencode($this->input->get_post($val,TRUE));
        }
        $data['keyword']   = $data['keyword'];
        $data['bigclass']   = $data['bigclass'];
        $data['smallclass']   = $data['smallclass'];
        ...
        $where['like|trade']      = $data['bigclass'];
        $where['like|strade']      = $data['smallclass'];
