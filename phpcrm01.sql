...
CREATE TABLE `ci_customer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(511) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '' COMMENT '任务名称',
  `area1` varchar(50) DEFAULT '' COMMENT '任务国家',
  `area2` varchar(100) DEFAULT '' COMMENT '所属城市(Null)',
  `source` varchar(50) DEFAULT '' COMMENT '所属联盟',
  `trade` varchar(50) DEFAULT '' COMMENT '任务类型(Null)',
  `type` varchar(50) DEFAULT '' COMMENT '流量状况',
  `address` varchar(511) DEFAULT '' COMMENT '账号信息',
  `email` varchar(50) DEFAULT '' COMMENT '邮箱(Null)',
  `start` varchar(50) DEFAULT '0' COMMENT '流量状况',
  `groupid` int(11) DEFAULT '0',
  `linkman` varchar(100) DEFAULT '任务链接',
  `job` varchar(200) DEFAULT '' COMMENT '任务链接(Null)',
  `zip` varchar(50) DEFAULT '',
  `qq` varchar(50) DEFAULT '任务要求',
  `mobile` varchar(512) DEFAULT '' COMMENT '合作站点',
  `website` varchar(150) DEFAULT '' COMMENT '公司网址(Null)',
  `remark` varchar(255) DEFAULT '' COMMENT '备注(Null)',
  `reapp` tinyint(4) DEFAULT '1',
  `uid` int(11) DEFAULT '0' COMMENT '业务员ID',
  `adddate` date DEFAULT NULL COMMENT '录入时间',
  `addtime` datetime DEFAULT NULL,
  `adduser` varchar(50) DEFAULT '' COMMENT '工号',
  ...
  `record` varchar(2048) DEFAULT NULL COMMENT '任务代码',
  PRIMARY KEY (`id`),
  KEY `id` (`id`)
...
CREATE TABLE `ci_linkman` (
  ...
  `customername` varchar(100) DEFAULT '',
  `name` varchar(2048) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '0' COMMENT '任务链接',
